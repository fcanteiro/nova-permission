...
public function tools()
{
    return [
        // ...
        \Workup\NovaPermission\NovaPermissionTool::make(),
    ];
}
```
...
'middleware' => [
    // ...
    \Workup\NovaPermission\ForgetCachedPermissions::class,
],
```
...
public function fields(Request $request)
{
    return [
        // ...
        MorphToMany::make('Roles', 'roles', \Workup\NovaPermission\Role::class),
        MorphToMany::make('Permissions', 'permissions', \Workup\NovaPermission\Permission::class),
    ];
}
```
...
```php
// ...
use Workup\NovaPermission\PermissionBooleanGroup;
use Workup\NovaPermission\RoleBooleanGroup;
...
// ...
use Workup\NovaPermission\PermissionBooleanGroup;
use Workup\NovaPermission\RoleSelect;
